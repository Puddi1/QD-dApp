...
import FirstERC1155Facet from "../artifacts/contracts/validator/facets/FirstERC1155Facet.sol/FirstERC1155Facet.json" assert {type: 'application/json'};
import FirstAvalancheValidatorSettersAndGettersFacet from "../artifacts/contracts/validator/facets/FirstAvalancheValidatorSettersAndGettersFacet.sol/FirstAvalancheValidatorSettersAndGettersFacet.json" assert {type: 'applicationjson'};
import FirstAvalancheValidatorDepositFacet from "../artifacts/contracts/validator/facets/FirstAvalancheValidatorDepositFacet.sol/FirstAvalancheValidatorDepositFacet.json" assert {type: 'application/json'};
import FirstAvalancheValidatorHealthAndUpgradesFacet from "../artifacts/contracts/validator/facets/FirstAvalancheValidatorHealthAndUpgradesFacet.sol/FirstAvalancheValidatorHealthAndUpgradesFacet.json" assert {type: 'application/json'};
